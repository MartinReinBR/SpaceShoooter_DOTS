...
public partial class SetCollisionBoundsSystem : SystemBase
{
    protected override void OnUpdate()
    {
        Entities
             .WithoutBurst()
             .WithAll<PlayerTag>()
             .ForEach((ref CollisionAABBComponent collision, in Transform transform) =>
             {
        ...
        Entities
            .WithAll<EnemyTag>()
            .ForEach((ref CollisionAABBComponent collision, ref Translation position) =>
            {
                float size = 1f / 2f;
        ...
        Entities
           .ForEach((ref CollisionSphereComponent sphere, in Translation position) =>
           {
